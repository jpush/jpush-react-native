 ...
 */
RCT_EXPORT_METHOD( setTags:(NSString *)tags
  ...
  [JPUSHService setTags:tagSet alias:alias callbackSelector:@selector(tagsAliasCallback:tags:alias:) target:self];
}
...
//    tagSet = [NSSet setWithObject:tags];
//  }
//  [JPUSHService setTags:tagSet alias:alias callbackSelector:cbSelector object:theTarget];
//}
...
- (void)tagsAliasCallback:(int)iResCode
                     tags:(NSSet *)tags
                    alias:(NSString *)alias {
  NSNumber *resultNumber = [NSNumber numberWithInt:iResCode];
  self.asyCallback(@[resultNumber]);
}
//
//RCT_EXPORT_METHOD(setTags:(NSString *)tags
//                    alias:(NSString *)alias
...
//    tagSet = [NSSet setWithObject:tags];
//  }
//  [JPUSHService setTags:tagSet alias:alias fetchCompletionHandle:completionHandler];
//}
//
//RCT_EXPORT_METHOD(  setTags:(NSString *)tags
...
//    tagSet = [NSSet setWithObject:tags];
//  }
//  [JPUSHService setTags:tagSet aliasInbackground:alias];
//}
//
